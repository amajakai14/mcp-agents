...
@mcp.tool("get_qa_agent", description="Get information about the Quality Assurance Agent")
...
@mcp.tool("list_all_agents", description="List all available agents with their basic information")
